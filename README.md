...
Test Driven Development, relies on repetitve short term development cycles to ensure that features are added to an application very specific test help improve software reliability. This minimizes risk for bugs that can be tough debug because it is so imbeded in the code. I think this is a great design for simple applications and confidence.
	

1. Mention three types of automated tests.

 Unit tests, integration tests, and snapshot tests.
